    ...
    <div className="w-screen h-screen bg-[#FEFFF0] flex items-center justify-center px-4 md:px-12">
      <div className="w-full max-w-7xl grid grid-cols-3 grid-rows-3 h-full min-w-0">
        ...
        <motion.div
          ...
          custom={2}
        >
          <p className="text-3xl font-extrabold text-[#37806B] leading-snug">A lab</p>
          <p className="text-base font-medium text-[#1E1E1E]">where playful ideas quietly sprout,</p>
          <p className="text-base font-medium text-[#1E1E1E]">and grow with wonder and curiosity.</p>
        </motion.div>
